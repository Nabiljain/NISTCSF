...
*       https://app.skaffolder.com/#!/register?friend=5eb1994782f82d390e784adb
*
...
function getConnection() {
	...
	global $db_NISTCSF_db_Url, $db_NISTCSF_db_User, $db_NISTCSF_db_Pass, $db_NISTCSF_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_NISTCSF_db_Url.";dbname=".$db_NISTCSF_db_DbName, $db_NISTCSF_db_User, $db_NISTCSF_db_Pass);
